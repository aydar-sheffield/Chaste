...
public:
    ...
    void TestBasicElement()
    {
        ...
        std::vector<HEVertex<2>* > element_vertices = {vertices[0], vertices[1], vertices[2], vertices[3]};
        ...
        while (next_twin_edge!=twin_edge)
        {
            ...
            c_vector<double, 2> next_twin_edge_twin_target = next_twin_edge_twin->GetTargetVertex()->rGetLocation();
            c_vector<double, 2> previous_twin_edge_target = previous_twin_edge->GetTargetVertex()->rGetLocation();
